...
def create_plot8():
    ...
    # Atribuindo a variáveis o nome das colunas que serão usadas, com o intuito de deixar o código mais legível.
    ...
    # Definindo características gerais do gráfico
    ...
    # Alterando o tipo, a cor e o tamanho da fonte do título
    p.title.text_font = "Times New Roman"
    p.title.text_color = "#50C4F2"
    p.title.text_font_size = "18pt"

    # Alterando o tipo, a cor e o tamanho da fonte dos rótulos dos eixos
    ...
    # Definindo os glifos da representação gráfica
