...
def create_plot2():
    ...
    p = figure(width=600, height=400, title="Relação entre consumo de cafeína e sono profundo", background_fill_color="#38375c",
    ...
    p.star(x= 'Deep sleep percentage', y= 'Caffeine consumption', size=14, fill_color='#f2e6c9', line_color='#f2e6c9', alpha=0.5, source=source)
...
def create_plot3():
    ...
    p1 = figure(x_range=smoking_status, height=400, title='Relação entre Smoking Status e Sleep Efficiency',
    ...
    p1.vbar(x='smoking_status', top='sleep_efficiency', width=0.5, fill_color="#38375C", line_color='black', alpha=0.7, source=source)
...
def create_plot4():
    ...
    p2 = figure(width=600, height=400, title='Relação entre Awakenings e Age',
    ...
    p2.star(x='Age', y='Awakenings', size=12, angle=-1.2, fill_color='#38375C', line_color=None, source=source)
